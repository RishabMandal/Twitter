...
export default function SinglePost({
  ...
  // Edit tweet
  const editTweet = (index1) => {
    settweets(
      tweets.map((tweet, index) => {
        if (index === index1) {
          console.log(tweet);
          tweet.tweet = EditInput;
          console.log(tweet);
        }
        return tweet;
      })
  ...
  return (
    <>
      ...
      <Transition show={isOpen} as={Fragment}>
        <Dialog
          className="fixed top-10 md:left-1/4 lg:left-1/4 xl:left-1/4 z-20"
        ...
        >
          ...
          >
            <Dialog.Panel>
              <div>
                <div className="p-2 rounded-xl md:w-[500px] lg:w-[800px] xl:w-[800px] bg-black text-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    ...
                    className="w-5 h-5 my-2 cursor-pointer hover:stroke-blue-500"
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <div>
                <div className="p-2 rounded-xl md:w-[500px] lg:w-[800px] xl:w-[800px] bg-black text-white">
                  <div className="flex">
                    ...
                    <div className="my-auto mx-1">Edit tweet</div>
                  </div>
                  <hr
                    style={{
                      color: "#292a2d",
